...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "191131a8": unref(CSSVariables).selectedColor,
      "72be2c63": unref(CSSVariables).hoverColor,
      "1dd3f139": unref(CSSVariables).tableHeight,
      "610d1746": unref(CSSVariables).theadBg,
      "66b9712a": unref(CSSVariables).tfootBg,
      "744e1a56": gridColumnsCount.value
    }));
