import { defineComponent, useCssVars, unref, computed, openBlock, createElementBlock, normalizeClass, withKeys, withModifiers, renderSlot } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "7b416a86": bg.value,
      "8f7e99fc": unref(textColorComputed)
    }));
    const props = __props;
    const emit = __emit;
    const onClick = () => {
    ...
    return (_ctx, _cache) => {
      return __props.hidden ? (openBlock(), createElementBlock("div", _hoisted_1)) : (openBlock(), createElementBlock("div", {
        key: 1,
